    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                权限<span class="am-icon-code"></span> 列表
            </div>
        </div>
        <div class="tpl-block">
            <div class="am-g">
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <a href="{{url('admin/power/permission/create')}}">
                            ...
                            @foreach($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{--<div class="am-btn-toolbar">--}}
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" onclick="location.href='{{url('admin/power/permission/create',['id'=>$item->id])}}'" class="am-btn am-btn-default am-btn-warning"><span class="am-icon-archive"></span>编辑</button>
                    ...
                    $('.btn_delete').on('click', function() {
                        ...
                        $('#my-confirm').modal({
                            ...
                            onConfirm: function(options) {
                                ...
                                var url="{{url('admin/power/permission/delete')}}"+"/"+link.attr('del_id');
